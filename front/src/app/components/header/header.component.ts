...
export class HeaderComponent implements OnInit {
  ...
  adminLinks: Array<{title: string, link: string, icon: string}> = [
    ...
    { title: 'Mis pedidos', link: 'admin/mis-pedidos', icon: 'zmdi-assignment-check' },
  ...
  sellerLinks: Array<{title: string, link: string, icon: string}> = [
    ...
    { title: 'Mis pedidos', link: 'seller/mis-pedidos', icon: 'zmdi-assignment-check' },
  ...
  userLinks: Array<{title: string, link: string, icon: string}> = [
    ...
    { title: 'Mis pedidos', link: 'user/mis-pedidos', icon: 'zmdi-assignment-check' },
